...
const PodcastsCollectionPage: React.FC = () => {
    ...
    const [getEpisodes, { data: episodes, isFetching: episodesIsFetching }] = spotifyApi.useLazyGetCurrentUserSavedEpisodesQuery();
            ...
            <section className="px-content-spacing py-16">
                ...
                <div className="grid grid-cols-dynamic gap-dynamic">
                    <Link
                        ...
                        className={"group bg-liked-episodes-in-playlists-collection col-span-2 rounded-[clamp(4px,32px_*_0.025,8px)]"
                            .concat(" text-base p-5 flex flex-col gap-5")}
                    >
                        <div className="flex-grow flex items-end">
                            <div className="line-clamp-3 text-sm">
                                {episodes && episodes.items.map(({ episode: { name, show, id } }, i) => (
                        ...
                        <div className="min-h-[62px] leading-relaxed relative">
                            ...
                            {episodes?.total && (
                                <p className="text-sm">{episodes.total} episodes</p>
                            )}
